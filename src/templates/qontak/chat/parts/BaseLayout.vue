    ...
    <PixelSidebarChild v-if="props.isShowChildMenu">
      ...
      >
        <MpFlex justify="space-between" alignItems="center" height="36px">
          ...
          <MpFlex gap="1">
            <MpButton aria-label="add button" left-icon="add" variant="ghost" size="sm" :class="css({ color: 'blue.400'})" />
            <MpButton aria-label="search button" left-icon="search" variant="ghost" size="sm"  :class="css({ color: 'blue.400'})" />
          </MpFlex>
        </MpFlex>
