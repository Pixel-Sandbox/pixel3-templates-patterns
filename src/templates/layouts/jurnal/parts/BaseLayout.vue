<script setup lang="ts">
  ...
  setAccountInformation({
    companyId: '12345678',
    companyName: 'Prima FNB',
    fullName: 'Rizal Chandra',
    userPhoto: 'https://cdn.mekari.design/pixel3-docs/avatar/1.png'
  })
...
<template>
  <PixelNavbar>
    <template #left>
      <RouterLink to="/templates/layouts/jurnal">
        <img
        ...
        <img
          ...
          src="https://cdn.mekari.design/logo/jurnal/white.svg"
          alt=""
          height="56"
          width="auto"
        />
    ...
    <template #right>
      ...
      <JurnalActivityLog> Content </JurnalActivityLog>
