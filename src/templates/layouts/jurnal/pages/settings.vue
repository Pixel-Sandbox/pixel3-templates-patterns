<!--
  @description
  Jurnal layout with child menu (e.g. settings): BaseLayout with isShowChildMenu, sidebar collapsed. For settings or nested pages.
-->
<script setup lang="ts">
  ...
  // Update sidebar collapse programmatically.
