...
<template>
  <MpFlex flexDirection="column" minHeight="100vh" bg="background">
    <MpFlex direction="column" alignItems="center" justifyContent="center" pt="8" px="8" gap="4">
      <MpFlex>
        <img src="https://cdn.mekari.design/logo/pixel/default.svg" alt="" height="56" width="auto">
      </MpFlex>
    ...
    >
      <section>
        ...
        >
          <RouterLink
            v-for="(route, index) in getPatternRoutes" :key="index"
            :to="route.path"
            :class="css({
              rounded: 'xl',
              bg: 'white',
          ...
          >
            <img
              :class="css({
                roundedTop: 'xl',
                objectFit: 'cover',
              })" src="/cover/patterns/default.png" alt=""
            >
            ...
            >
              ...
              <MpText
                weight="semiBold" size="h3" :class="css({
                  mt: 2,
                })"
              >
                {{ route.title }}
      ...
      <section v-for="key in Object.keys(getGroupedTemplateRoutes)" :key="key">
        ...
        >
          <RouterLink
            v-for="template in getGroupedTemplateRoutes[key]" :key="template.path"
            :to="template.path"
            :class="css({
              rounded: 'xl',
              bg: 'white',
