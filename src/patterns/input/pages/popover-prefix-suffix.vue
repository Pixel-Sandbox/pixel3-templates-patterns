...
import { MpFormControl, MpFormLabel, MpIcon, MpInput, MpInputGroup, MpInputLeftAddon, MpInputRightAddon, MpPopover, MpPopoverContent, MpPopoverList, MpPopoverListItem, MpPopoverTrigger, MpText, css } from '@mekari/pixel3'
...
function getAllRegions() {
  fetch(
    ...
    .then(res => res.json())
    .then(data => (regions.value = data.map((v: Regions, i: number) => {
      return {
        ...v,
        id: i,
        height: 37,
